...
import WaterFlowBarChart from '@/app/features/waterFlowBarChart/WaterFlowBarChart';
import { WaterFlowBarChartElement } from '@/app/features/waterFlowBarChart/props';
...
export default class CashFlowBarChart extends React.Component<CashFlowBarChartProps> {
  waterFlowBarChartData(): WaterFlowBarChartElement[] {
    ...
    return [
      ...
      },
      {
        ...
        previousSum: startingCash + operatingActivitiesCashFlow + investingActivitiesCashFlow,
      },
      {
        name: '期末残',
  ...
  render(): React.ReactNode {
    if (this.hasNoData()) {
      return <ChartAlternative>キャッシュフロー計算書: データがありません。</ChartAlternative>;
    }
